...
const Header = () => {
  ...
  const handleSubmitLoggin = async (evt) => {
    evt.preventDefault();
    const res = await fetch('https://apidog-2.vercel.app/user/register', {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (evt) => {
    ...
    const res = await fetch('https://apidog-2.vercel.app/user', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
        ...
        <div className='header__containerform'>
          ...
          <form onSubmit={handleSubmit} className='header__form '>
            <div className='header__background header__form-h'>
              ...
              <button className='header__buttons-action'>Create Acount</button>
              {userSend ? null : (
                <div className='header__controller'>
